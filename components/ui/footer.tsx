  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* Bottom area */}
        <div className="md:flex md:items-center md:justify-left py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="mb-2 ml-5 pr-5">
            <Logo />
          </div>
          <div className="text-sm text-gray-600 mr-4">&copy; limitlessnetwork.org. All rights reserved.</div>
